 ...
 * <p>
 * This class ensures that the internal domain model is decoupled from
...
public class MapperEmployee {
        ...
        /**
         * Maps an {@link Employee} entity to an {@link EmployeeDtoResponse} for API
         * output.
         * * @param employee The employee entity containing full data.
         * 
         * @return A filtered {@link EmployeeDtoResponse} suitable for the client
         *         response.
         */
        ...
        public ArrayList<EmployeeDtoResponse> return_employee_list_employee_dto_response(List<Employee> list_employee) {
                ArrayList<EmployeeDtoResponse> list_employees = new ArrayList<>();
                for (Employee emplo : list_employee) {
                        list_employees.add(getEmployee(emplo));
                }
