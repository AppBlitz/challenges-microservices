...
// ─── 1. Mockear mongoose PRIMERO (tiene top-level await en mongo_db.js) ───────
...
// ─── 3. Imports dinámicos SIEMPRE después de los mocks ───────────────────────
const { insert_log_save_employee, search_log } =
  await import("../src/services/service_logs.js");
